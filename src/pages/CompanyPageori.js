    ...
    <div className={classNames(classes.main)}>
        ...
        <li className={classNames(classes.tableli)}>
          <button
            ...
            className={classNames(
              ...
              changeButtonColorFor("companyName")
            )}
          >
            PRADA
          </button>
      ...
      <div className={classNames(classes.tablecontainer)}>
        <table className={classNames(classes.sorttable)}>
          <thead>
            <tr>
              <th className={classNames(classes.tableth)}>Rank</th>
              <th className={classNames(classes.tableth)}>Company</th>
              <th className={classNames(classes.tableth)}>Platform</th>
              <th className={classNames(classes.tableth)}>Researchers</th>
              <th className={classNames(classes.tableth)}>Algorithm</th>
              <th className={classNames(classes.tableth)}>Data</th>
              <th className={classNames(classes.tableth)}>Applications</th>
            </tr>
          </thead>
          <tbody>
            {items.map((product) => (
              <tr key={product.id}>
                ...
                <td className={classNames(classes.tabletd)}>
                  {product.companyName}
                </td>
                <td className={classNames(classes.tabletd)}>
                  {product.platform}
